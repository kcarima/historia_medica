<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 form-forgot">
        <h2 class="form-forgot-heading centered">Recuperación de Contraseña</h2>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <x-primary-button>
                {{ __('Enlace de Restablecimiento de Contraseña al Correo Electrónico') }}
            </x-primary-button>
        </div>
    </form>
</x-guest-layout>
